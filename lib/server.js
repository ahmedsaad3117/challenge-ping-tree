...
router.set('/api/targets',{
  POST: controllers.createTarget,
  GET: controllers.getAllTargets
})

router.set('/api/targets/:id',{
  GET: controllers.getTargetById,
  POST: controllers.updateTargetById
})

router.set('/route',{
  POST: controllers.makeingDecision
})
