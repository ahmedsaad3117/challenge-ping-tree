...
router.set('/api/targets',{
  POST: (req, res, opt) => controllers.createTarget(req,res,opt),
  GET: (req, res) => controllers.getAllTargets(req,res)
})

router.set('/api/targets/:id',{
  GET:(req, res, opts) => controllers.getTargetById(req, res, opts),
  POST:(req, res, opts) => controllers.updateTargetById(req, res, opts)
})

router.set('/route',{
  POST:(req, res, opts) => controllers.makeingDecision
})
